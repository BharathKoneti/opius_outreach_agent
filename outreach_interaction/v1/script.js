...
class DialogueSystem {
    ...
    updateScript(vcName, portfolio, fact, tone) {
        this.currentScript = dialogueScripts.default.map(line => ({
            ...line,
            text: line.text
                .replace('[VC Name]', vcName || '[VC Name]')
                .replace('[Startup Name]', portfolio || '[Startup Name]')
        }));
    }
...
function setupControls() {
    ...
    document.getElementById('update-script').addEventListener('click', () => {
        const vcName = document.getElementById('vc-input').value;
        ...
        dialogueSystem.updateScript(vcName, portfolio, fact, tone);
        document.getElementById('vc-name').textContent = vcName || '[VC Name]';
    });
